...
public Plugin:myinfo = 
{
    ...
    author = "Starbish, Modified by. SHIM",
...
int g_iFileExtCount[] = { 5, 2, 4, 1 };
char g_cFileExtension[][][] = { {"mdl", "vvd", "vtx", "phy", "ani"}, {"vmt", "vtf", "", "", ""}, {"mp3", "wav", "wmv", "wma", ""}, {"pcf", "", "", "", ""} };
int g_iCacheFileExtCount[] = { 1, 1, 4, 1 };
char g_cCacheFileExtension[][][] = { {"mdl", "ani", "", ""}, {"", "", "", ""}, {"mp3", "wav", "wmv", "wma"}, {"pcf", "", "", ""} };
					...
					for(int x = 0; x < g_iCacheFileExtCount[index]; x++){
						...
						if(StrEqual(cExtensionName, g_cCacheFileExtension[index][x])){
							...
							if(index == 0 || index == 1)
								...
								ReplaceStringEx(cBuffer, sizeof(cBuffer), "particles/", "");
