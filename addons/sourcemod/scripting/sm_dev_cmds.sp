...
public void OnPluginStart()
{
	...
	if( g_iGAMETYPE == GAME_L4D || g_iGAMETYPE == GAME_L4D2 )
	{
		...
		RegAdminCmd("sm_coop",			CmdCoop,		ADMFLAG_ROOT, "Sets the game mode to Coop.");
		RegAdminCmd("sm_realism",		CmdRealism,		ADMFLAG_ROOT, "Sets the game mode to Realism.");
		RegAdminCmd("sm_survival",		CmdSurvival,	ADMFLAG_ROOT, "Sets the game mode to Survival.");
		RegAdminCmd("sm_versus",		CmdVersus,		ADMFLAG_ROOT, "Sets the game mode to Versus.");
